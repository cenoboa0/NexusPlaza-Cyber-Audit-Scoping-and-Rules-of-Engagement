...
* **Entorno:** La mayoría de las pruebas se realizarán en sistemas de producción. Las pruebas intrusivas de SQL Server se limitarán a un entorno de desarrollo configurado de forma idéntica.
* **Origen del Acceso:** El acceso será interno a través de una **VLAN aislada** proporcionada específicamente por el departamento de TI.
* **Ingeniería Social:** Autorizada únicamente contra una lista limitada de direcciones de correo electrónico proporcionada por el cliente.
* **Ataques Disruptivos:** Permitidos (incluyendo DoS) solo durante las ventanas de mantenimiento programadas (Viernes a Domingo, 02:00 - 06:00 AM).

## 5. Ubicación Física
El centro de datos objeto de la auditoría se encuentra físicamente en las instalaciones de **Houston**.
